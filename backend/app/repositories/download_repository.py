...
from app.repositories.completion_repository import CompletionRepository
from app.repositories.download_delete_repository import DownloadDeleteRepository
